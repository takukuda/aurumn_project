...
function imgchange5(){document.getElementById("logo").classList.remove("imagechange2"); document.getElementById("logo").classList.add("imagechange1");}
function imgchange6(){document.getElementById("logo").classList.remove("imagechange1"); document.getElementById("logo").classList.add("imagechange2");}
